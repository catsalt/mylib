...
var (
	...
	// wGetDesktopWindow = wUser32.NewProc("GetDesktopWindow")
	// wGetDC            = wUser32.NewProc("GetDC")
	// wReleaseDC        = wUser32.NewProc("ReleaseDC")
	

	wGetCursorPos     = wUser32.NewProc("GetCursorPos")
	wSetCursorPos = wUser32.NewProc("SetCursorPos")
	// wGetSystemMetrics = wUser32.NewProc("GetSystemMetrics")
